...
if (username == null || username == undefined || username === "") {
	...
	whatsappEl.href = `https://web.whatsapp.com/send?text=🚩 महाशिवरात्रि की हार्दिक शुभकामनायें 🚩%0Aआपके लिए विशेष सन्देश है%0Aयहाँ पे क्लिक करे 👇%0A ${window.location}`;
} else {
	facebookEl.href = "https://www.facebook.com/sharer/sharer.php?u=shubhkaamna.site";
	...
	whatsappEl.href = `https://web.whatsapp.com/send?text=🚩 महाशिवरात्रि की हार्दिक शुभकामनायें 🚩%0A*${username}* ने आपके लिए विशेष सन्देश भेजा है%0Aयहाँ पे क्लिक करे 👇%0A ${window.location}`;
